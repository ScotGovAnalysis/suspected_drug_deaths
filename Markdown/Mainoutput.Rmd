---
title: "Suspected drug deaths in Scotland: July to September 2022"
...
source("C:/Users/u449921/Documents/SuspectedDrugDeaths/Code/Q3_Functions.R")
...
There were `r latest_3Q` suspected drug deaths during the first nine months of `r year`. This was `r latest_3Q_comparison_prop`% (`r latest_3Q_comparison_diff`) `r latest_which2` than during the same period of `r year_prev`. There has been a downward trend in the rolling 12-month suspected drug death total (Figure 1), but numbers remain high.
...
Between January and `r last_month` `r year`:
  ...
  * There were `r latest_3Q` suspected drug deaths, `r latest_3Q_comparison_prop`% (`r latest_3Q_comparison_diff`) `r latest_which2` than during the same period of `r year_prev`.
